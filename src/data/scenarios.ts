    ...
    zones: [
      ...
      },
      {
        ...
        details: [
          ...
          'Commuters are stranded ΓÇö seek shelter',
        ],
      },
      {
        id: 'kowdiar',
      ...
      },
      {
        ...
        details: [
          ...
          'Avoid this route ΓÇö find alternate roads',
        ],
      },
    ],
    iot: {
    ...
    advisories: [
      {
        level: warning,
        emoji: 'ΓÜá∩╕Å',
        text: 'Flood alert near Kowdiar area ΓÇö consider alternate route',
        time: 'Just now',
      },
      {
        level: warning,
        emoji: '≡ƒö┤',
        text: 'Thampanoor bus stand flooded ΓÇö buses delayed or cancelled',
        time: '3 min ago',
      },
      {
        level: warning,
        emoji: 'ΓÜá∩╕Å',
        text: 'Waterlogging on MG Road ΓÇö drive very slowly',
        time: '8 min ago',
      },
      {
        level: caution,
    ...
    advisories: [
      {
        level: warning,
        emoji: '≡ƒö┤',
        text: 'Heavy congestion at Thampanoor ΓÇö expect 20+ minute delays',
        time: 'Just now',
      },
      {
        level: caution,
        emoji: '≡ƒƒí',
        text: 'MG Road is slow-moving ΓÇö consider public transport',
        time: '4 min ago',
      },
      {
        level: warning,
        emoji: 'ΓÜá∩╕Å',
        text: 'Bus stands are overcrowded ΓÇö be patient while boarding',
        time: '10 min ago',
      },
      {
        level: caution,
        emoji: '≡ƒƒí',
        text: 'Drive carefully ΓÇö increased traffic accident risk this evening',
        time: '18 min ago',
      },
    ],
  },
